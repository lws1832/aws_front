...
export const getComment = async (dispatch) => {
    ...
    try{
        const response = await fetch('http://api.leewoo.shop/api/comment')
...
export const postComment = async (dispatch,body) => {
    ...
    try{
        //code block
        const options = { //리퀘스트 매서드에 해더쪽이나 바디쪽 매서드를 채울 수 있다.
            method:'POST',
            headers: {
        ...
        const response = await fetch('http://api.leewoo.shop/api/comment',options)
        const data = await response.json()
...
export const patchComment = async (dispatch,body) => {
    ...
    try{
        ...
        const response = await fetch(`http://api.leewoo.shop/api/comment/${body.index}`,options)
        const data = await response.json()
...
export const deleteComment = async (dispatch,body) => {
    ...
    try{
        ...
        const response = await fetch(`http://api.leewoo.shop/api/comment/${body}`,options)
        const data = await response.json()
